import { LOGO_URL } from '@/src/constants/brand';
import type { Orcamento, CompanySettings } from '@/src/api/orcamentos';
...
export function buildOrcamentoHtml(orc: Orcamento, company: CompanySettings): string {
  ...
  const empty = (orc.items || []).length === 0
